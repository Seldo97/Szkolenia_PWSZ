...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Sty 2020, 21:03
...
(2, 2, '2020-01-10', '200', b'1', '2019-12-28'),
(3, 20, '2020-01-28', '500', b'1', '2019-12-29'),
(4, 21, '2020-01-28', '500', b'1', '2019-12-29'),
(5, 22, '2020-01-28', '500', b'1', '2019-12-29'),
(6, 23, '2020-01-28', '500', b'1', '2020-01-05'),
(7, 24, '2020-01-28', '500', NULL, NULL),
(8, 25, '2020-01-29', '150', NULL, NULL),
(9, 26, '2020-01-29', '300', NULL, NULL),
(10, 27, '2020-01-29', '300', NULL, NULL),
(11, 28, '2020-01-29', '300', NULL, NULL),
(12, 29, '2020-01-29', '300', NULL, NULL),
(13, 30, '2020-02-05', '500', NULL, NULL),
(14, 31, '2020-02-07', '200', NULL, NULL);
...
(10, 'test', '2019-12-27', '12:00:00', 106, 4, 1, '300', 'Lol');
...
(42, 'Marcin', 'lol', 'eloelo', '1997-09-03', 'lol@gmail.com', '998855411', 2);
...
(35, 'seldo', '$2y$10$/13kD/qCH6rTmzpsiV3x3.N9VNHhMtPZF9YcYtggLKAgYvnzNSAfe', 'lol@gmail.com', 1),
(36, 'admin', '$2y$10$UQqpShlve9A.KLTvMM0V4uzZQADNGJwHgJ4mPzNZs2xHx31lFan8C', 'admin@admin.pl', 2),
(37, 'trener', '$2y$10$BiMHmCwHmUAVqcRvSH2J.uW76joP/nHS8ARFrE9ul84DdT7tCqX/2', 'Andrzej@wp.pl', 3);
...
--
-- Indexes for table `szkolenie_uczestnik`
--
...
--
-- Indexes for table `wyksztalcenie`
--
...
--
ALTER TABLE `certyfikat`
  MODIFY `id_certyfikat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `platnosc`
  MODIFY `id_platnosc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `szkolenie`
  MODIFY `id_szkolenie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT dla tabeli `szkolenie_uczestnik`
--
ALTER TABLE `szkolenie_uczestnik`
  MODIFY `id_szkolenie_uczestnik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
...
--
ALTER TABLE `uczestnik`
  MODIFY `id_uczestnik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT dla tabeli `uprawnienia`
--
ALTER TABLE `uprawnienia`
  MODIFY `id_uprawnienia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT dla tabeli `uzytkownik`
--
ALTER TABLE `uzytkownik`
  MODIFY `id_uzytkownik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
